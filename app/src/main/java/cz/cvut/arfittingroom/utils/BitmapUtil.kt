...
object BitmapUtil {
     ...
     */
    fun replaceNonTransparentPixels(bitmap: Bitmap, newColor: Int) {
        ...
        for (i in pixels.indices) {
            ...
            if (alpha != 0) {  // Check if the pixel is not completely transparent
                pixels[i] = (alpha shl 24) or (newColor and 0x00FFFFFF)
            }
        }
