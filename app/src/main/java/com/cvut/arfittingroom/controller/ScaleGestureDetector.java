...
public class ScaleGestureDetector {
    ...
    private static final int DEFAULT_MIN_SPAN_SLOP = 48;
    private static final int DEFAULT_MIN_SPAN = 450;
...
//                    new InputEventConsistencyVerifier(this, 0) : null;
    ...
    public ScaleGestureDetector(@NonNull Context context, @NonNull OnScaleGestureListener listener,
        ...
        if (mSpanSlop == 0) {
            mSpanSlop = DEFAULT_MIN_SPAN_SLOP;
        }
        mMinSpan = viewConfiguration.getScaledMinimumScalingSpan();
        if (mMinSpan == 0) {
            mMinSpan = DEFAULT_MIN_SPAN;
        }
        mHandler = handler;
