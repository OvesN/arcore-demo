        ...
        AlertDialog.Builder(this)
            ...
            .setItems(options) { _, which ->
                ...
                when (options[which]) {
                    ...
                    ELayerEditAction.MOVE_DOWN.string -> drawView.moveLayer(layerIndex, layerIndex - 1)

                    ELayerEditAction.MOVE_UP.string -> drawView.moveLayer(layerIndex, layerIndex + 1)
